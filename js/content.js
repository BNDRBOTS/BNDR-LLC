...
window.BNDR_CONTENT = {
  ...
  builder: {
    kicker: "The Builder",
    title: "Hi, I'm Scott. I build all of this myself.",
    introMd: "BNDR is one person. Me. There is no team behind the curtain: I do the design, the writing, the code, and the testing from my desk in Phoenix, Arizona.\n\nThe way I work is simple. You get **honest work at a price you agreed to before anything started.** No retainers you can't get out of, no surprise invoices. Everything I build for you is yours, code and assets included, and when you need a change you talk to me directly.\n\nMost of my work comes from referrals: someone sees a site I built, asks who made it, and gets my number. I'd rather earn work that way than buy it with ads.",
    shipped: [
    ...
    ctaMd: "If you're building something real, or you know someone who needs a site that actually works, reach out. You'll be talking to me from the first message."
  },
